...
const MenuIconBar: React.FC = (): JSX.Element => {
  return (
...
const FontFamilySelector: React.FC = (): JSX.Element => {
  return (
...
const FontSizeSelector: React.FC = (): JSX.Element => {
  const fontRange: string[] = range(10, 30, 2);
  return (
